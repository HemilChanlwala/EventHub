  ...
  return (
    <div className="glass overflow-hidden rounded-xl flex flex-col">
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        <div className="text-sm text-indigo-200 mt-2">{date} • {location}</div>
        <div className="mt-3 flex items-center justify-between">
          <div className="font-bold text-indigo-300">{price}</div>
          <div className="flex items-center gap-2">
            <Link to={id ? `/events/${id}` : '/events'} className="text-sm text-white/80 hover:underline">View</Link>
