  ...
  return (
    <div className="max-w-7xl mx-auto p-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="lg:col-span-2">
        <div className="h-64 bg-gray-200 rounded mb-4 flex items-center justify-center text-gray-500">Banner</div>
        ...
        <section className="mt-8">
          ...
          <ul className="space-y-2">
            <li>Starts: {formatDate(event.date)}</li>
          </ul>
        </section>
      ...
      <aside className="p-6 border rounded h-fit">
        ...
        <div className="mt-4">
          ...
          <div className="text-lg">{event.seatsAvailable} / {event.seats}</div>
        </div>
